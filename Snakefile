...
rule all:
    input:
        ...
        expand("out/mm/seq/gses/{gse}.tsv", gse=["GSE100000"])
        #expand("out/mm/seq/gses/{gse}.tsv", gse=["GSE89477", "GSE89263"]),
        #expand("out/hs/seq/gses/{gse}.tsv", gse=["GSE51254", "GSE69790", "GSE124989", "GSE125300", "GSE132525",
...
# todo use filter_gsm_df func to subset srr_df on organism
